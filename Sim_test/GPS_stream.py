# Code to check if you are getting GPS streams from both USB0 and ACM0
...
# Configure ports
gps_sources = [
    ("USB_Pixhawk", "/dev/ttyACM0", 9600),     # or /dev/ttyAMA0 or /dev/serial0
    ("Telemetry", "/dev/ttyUSB0", 9600)         # telemetry port
]
