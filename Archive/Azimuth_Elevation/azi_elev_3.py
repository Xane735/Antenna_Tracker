...
def adjust_angles_for_servo_limits(azimuth, elevation):
    ...
    return azimuth, max(0, min(180, elevation))  # Clamp elevation to 0–180
...
def calculate_elevation(lat1, lon1, lat2, lon2, alt1, alt2):
    ...
    ground_dist = math.acos(math.sin(lat1) * math.sin(lat2) + math.cos(lat1) * math.cos(lat2) * math.cos(d_lon)) * R
